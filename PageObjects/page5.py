...
class ConditionClass:
    ...
    def BookAppointmentButtonMethod(self):
        ...
        lead_field = WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='leadnamehome1']")))
        lead_field.send_keys("Test GJ Treatment ")
        contact_field = WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='contactnumhome1']")))
        ...
        Thanks = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.XPATH, "/html/body/div/div/div/h1")))
        print(Thanks.text)
