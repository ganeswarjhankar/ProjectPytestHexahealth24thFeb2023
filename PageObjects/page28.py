...
class Marketing_WhatsApp_Class:
    def __init__(self,driver):
        self.driver = driver

    def open(self):
        df = pd.read_excel(constants.MARKETING_WHATSAPP_URL, sheet_name=constants.MARKETING_WHATSAPP_SHEET)
        self.urls = df.sample(3, replace=False)['URL']

    def Marketing_Whatsapp_Method(self):
